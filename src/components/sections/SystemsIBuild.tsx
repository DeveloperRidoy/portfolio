...
export function SystemsIBuild() {
  return (
    <section id="systems" className="scroll-mt-16 py-20 sm:py-24">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeader
          label="Capabilities"
          title="Systems I Build"
          description="Production-grade software across backend services, workflow automation, cloud processing, and internal enterprise platforms."
        />
